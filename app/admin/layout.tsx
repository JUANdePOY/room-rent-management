          ...
          <nav className="flex justify-around items-center h-16">
            <Link
              ...
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors relative ${
                pathname === '/admin' ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
              }`}
            >
              {pathname === '/admin' && <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
            ...
            <Link
              href="/admin/rooms"
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors relative ${
                pathname.includes('/rooms') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
              }`}
            >
              {pathname.includes('/rooms') && <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            ...
            <Link
              href="/admin/tenants"
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors relative ${
                pathname.includes('/tenants') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
              }`}
            >
              {pathname.includes('/tenants') && <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            ...
            <Link
              href="/admin/bills"
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors relative ${
                pathname.includes('/bills') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
              }`}
            >
              {pathname.includes('/bills') && <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            ...
            <Link
              href="/admin/payments"
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors relative ${
                pathname.includes('/payments') ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
              }`}
            >
              {pathname.includes('/payments') && <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
              </svg>
