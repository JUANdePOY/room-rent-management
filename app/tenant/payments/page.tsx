    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-end justify-center sm:items-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-t-lg sm:rounded-lg p-4 sm:p-6 w-full max-w-[calc(100%-1rem)] sm:max-w-lg mx-2 sm:mx-4 my-2 sm:my-4 max-h-[85vh] sm:max-h-[90vh] overflow-y-auto">
